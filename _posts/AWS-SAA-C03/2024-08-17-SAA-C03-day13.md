...
- concurreny execution 1000 (can be increased)
- function < 50 mb
...
Execute some logic at the edge attach to cloud front distributions, and run the code close to user
...
- RDS proxy in private subnet connect to RDS, and Lambda must deployed in your VPC, RDS proxy never public
